...
public class QuestionPagerOffAdapter extends PagerAdapter {
    private List<Question> questions;
    private Context context;
    private SaveResult saveResult;
    private TestStepTwoOffViewModel viewModel;
    private int type;

    public QuestionPagerOffAdapter(Context context, List<Question> questions, TestStepTwoOffViewModel viewModel, int type) {
